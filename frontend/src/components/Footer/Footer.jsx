        ...
        <div className="container">
          ...
          <div className="footer-main">
            ...
            <div className="footer-section company-info">
              ...
              <p className="company-description">
                ...
                expert guidance, and 24/7 support for engineering projects.
              </p>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                ...
                <li><a href="/order-project">Order Project</a></li>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                ...
                <li><a href="/iot-projects">IoT Solutions</a></li>
                <li><a href="/ai-projects">AI & Machine Learning</a></li>
            ...
            <div className="footer-section contact-info">
              ...
              <div className="contact-items">
                ...
                <div className="contact-item">
                  ...
                  <a href="mailto:support@progify.com">support@progify.com</a>
                </div>
                <div className="contact-item">
                  <div className="contact-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="newsletter-section">
            <div className="newsletter-content">
              <h3>Stay Updated</h3>
              <p>Get the latest project updates and engineering insights delivered to your inbox.</p>
            </div>
